...
angular.module("lookAroundApp.services", []).factory("googleMap", [
  '$rootScope', function($rootScope) {
    ...
    factory.placeMarkers = function(data) {
      ...
      angular.forEach(data, function(item, key) {
        var latLng = new google.maps.LatLng(item.geometry.location.lat(), item.geometry.location.lng()), currentMarker;
        me.markers.push(currentMarker = new google.maps.Marker({
          map: me.map, position: latLng, animation: google.maps.Animation.DROP, icon: me.getIcon(count++)
        }));
